...
public class BackService extends Service implements RecognitionListener, SensorEventListener {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        runnable = new Runnable() {
            public void run() {
                speech = SpeechRecognizer.createSpeechRecognizer(BackService.this);
                Log.e(LOG_TAG, "isRecognitionAvailable: " + SpeechRecognizer.isRecognitionAvailable(BackService.this));
                speech.setRecognitionListener(BackService.this);
    ...
    private void startSensors() {
        if (sensorManager != null) {
            ...
            Log.d(SENSOR_TAG, "Sensor registered");
        } else {
